...
export declare class CattleDeviceHistoryRepository {
    ...
    create(entity: Partial<CattleDeviceHistory>): Promise<CattleDeviceHistory>;
    createWithManager(manager: EntityManager, entity: Partial<CattleDeviceHistory>): Promise<CattleDeviceHistory>;
