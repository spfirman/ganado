...
let ApplicationPermissionsService = ApplicationPermissionsService_1 = class ApplicationPermissionsService {
    constructor(redisService, configService) {
        this.redisService = redisService;
        this.configService = configService;
        this.logger = new common_1.Logger(ApplicationPermissionsService_1.name);
    }
        ...
        for (const permission of roleModulePermissions) {
            ...
            for (const entity in permission.module.access_details) {
                ...
                if (Object.prototype.hasOwnProperty.call(permission.module.access_details, entity)) {
                    ...
                    entity_permission
                        .split('')
                        .map((char, index) => char === '1' && role_permission[index] === '1' ? '1' : '0')
                        .join('');
                }
                ...
                if (permissions[permission.module.code][entity] == undefined) {
                    ...
                    permissions[permission.module.code][entity] = stored_entity_permission
                        .split('')
                        .map((char, index) => char === '1' || combined_entity_permission[index] === '1'
                        ? '1'
                        : '0')
                        .join('');
                }
...
ApplicationPermissionsService.DEFAULT_SESSION_TTL_SECONDS = 86400;
ApplicationPermissionsService.DEFAULT_REFRESH_TTL_SECONDS = 604800;
