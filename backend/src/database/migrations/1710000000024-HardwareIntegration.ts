...
export class HardwareIntegration1710000000024 implements MigrationInterface {
  name = 'HardwareIntegration1710000000024';

  public async up(queryRunner: QueryRunner): Promise<void> {
    // Add EID tag field to cattle
    ...
    // Create weighing media type enum
    await queryRunner.query(`
      DO $$ BEGIN
    ...
    // Create bridge device type enum
    await queryRunner.query(`
      DO $$ BEGIN
    ...
    // Create bridge device status enum
    await queryRunner.query(`
      DO $$ BEGIN
    ...
    // Create weighing_audit_log table
    await queryRunner.query(`
