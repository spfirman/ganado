...
export declare class CattleEartagHistoryRepository {
    ...
    create(entity: CattleEartagHistory): Promise<CattleEartagHistory>;
    createWithManager(manager: EntityManager, entity: CattleEartagHistory): Promise<CattleEartagHistory>;
