...
import { SyncBrandResponseDto } from '../dto/sync-brand.dto';
...
export declare class BrandController {
    ...
    syncBrands(sessionUser: SessionUserDto, brandsJson: string, files: Express.Multer.File[]): Promise<SyncBrandResponseDto>;
}
